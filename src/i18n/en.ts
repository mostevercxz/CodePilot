...
const en = {
  ...
  'remote.description': 'Connect to remote servers via SSH and run Claude Code sessions there.',
  'remote.addConnection': 'Add Connection',
  'remote.noConnections': 'No remote connections configured.',
  'remote.addFirst': 'Add your first connection',
  ...
  'remote.deleteConfirm': 'Are you sure you want to delete this remote connection?',
  'remote.newConnection': 'New Connection',
  'remote.editConnection': 'Edit Connection',
  'remote.selectDir': 'Select',
  'remote.emptyDir': 'Empty directory',
  'remote.form.name': 'Connection Name',
  'remote.form.namePlaceholder': 'My Server',
  'remote.form.host': 'Host',
  'remote.form.port': 'Port',
  'remote.form.username': 'Username',
  'remote.form.authMethod': 'Auth Method',
  'remote.form.authKey': 'SSH Key',
  'remote.form.authPassword': 'Password',
  'remote.form.authAgent': 'SSH Agent',
  'remote.form.privateKeyPath': 'Private Key Path',
  'remote.form.password': 'Password',
  'remote.form.passwordUnchanged': 'Leave empty to keep unchanged',
  'remote.form.claudePath': 'Claude CLI Path (on remote)',
  ...
  'remote.loadingSessions': 'Loading sessions...',
  'remote.noRemoteSessions': 'No Claude Code sessions found on this server.',
