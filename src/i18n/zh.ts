...
const zh: Record<TranslationKey, string> = {
  ...
  'nav.remote': '远程',
  'remote.title': '远程连接',
  'remote.description': '通过 SSH 连接到远程服务器，在那里运行 Claude Code 会话。',
  'remote.addConnection': '添加连接',
  'remote.noConnections': '暂无远程连接配置。',
  'remote.addFirst': '添加你的第一个连接',
  'remote.loading': '加载中...',
  'remote.connect': '连接',
  ...
  'remote.edit': '编辑',
  'remote.delete': '删除',
  'remote.deleteConfirm': '确定要删除此远程连接吗？',
  'remote.newConnection': '新建连接',
  'remote.editConnection': '编辑连接',
  'remote.selectDir': '选择',
  'remote.emptyDir': '空目录',
  'remote.form.name': '连接名称',
  'remote.form.namePlaceholder': '我的服务器',
  'remote.form.host': '主机',
  'remote.form.port': '端口',
  'remote.form.username': '用户名',
  'remote.form.authMethod': '认证方式',
  'remote.form.authKey': 'SSH 密钥',
  'remote.form.authPassword': '密码',
  'remote.form.authAgent': 'SSH Agent',
  'remote.form.privateKeyPath': '私钥路径',
  'remote.form.password': '密码',
  'remote.form.passwordUnchanged': '留空则保持不变',
  'remote.form.claudePath': 'Claude CLI 路径（远程）',
  ...
  'remote.loadingSessions': '加载会话中...',
  'remote.noRemoteSessions': '未在此服务器上找到 Claude Code 会话。',
